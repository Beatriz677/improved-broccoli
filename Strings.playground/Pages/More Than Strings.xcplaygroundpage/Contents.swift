...
let firstName = "Naomi"
let favoriteBook = "before I Fall"
let hoursOfReading = 2
let NaomiReadingTime = "At her Grandmother's house, \(firstName) had sat down to read \(favoriteBook), and she read it for \(hoursOfReading)."
//:
//:
